    ...
    for ii = 1:length(name_arguments)
        ...
        switch lower(name_arguments{ii})
            ...
            case 'markerfacecolor'
                marker_facecolor = value_arguments{ii};
            case 'markeredgecolor'
                marker_edgecolor = value_arguments{ii};
            otherwise
...
for ii = 1:num_data_groups
    ...
    h = scatter(x_circular, y_circular,...
        ...
        'MarkerFaceColor', marker_facecolor{ii},...
        'MarkerEdgeColor', marker_edgecolor{ii},...
...
if ~strcmp(axes_labels, 'none')
    ...
    for ii = 1:length(axes_labels)
        ...
        text(x_pos, y_pos, axes_labels{ii},...
            ...
            'BackgroundColor', 'none', ... %background_color,...
            'FontName', label_font,...
